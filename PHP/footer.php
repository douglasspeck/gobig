<?php
    ...
    echo '
    <footer>
        <h2 class="highlight">apoie o projeto!</h2>
        <h3>
            da forma que você puder,<br class="breakpoint">
            ajude-nos a impulsionar essa causa :)
        </h3>
        <h3 class="upper">
            Compartilhe <span class="highlight">•</span> Inscreva-se <span class="highlight">•</span> Voluntarie-se
        </h3>
        <hr>
        <h4>
